...
<header class="u-clearfix u-header u-header" id="sec-189d"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h5 class="u-text u-text-default u-text-1">Counter:{{numCorrect}}/{{numTotal}}</h5>
      </div></header>
</template>
<script>
export default {
